    ...
    return (
        <div className="bg-[url('/images/hero.png')] h-fit bg-cover bg-no-repeat text-d-violet-blue flex justify-center">
            <div className="flex flex-col p-5 max-w-7xl my-96 text-center">
                ...
                <Link href={"/products"} className="w-fit"><button className="text-2xl p-4 border border-d-violet-blue rounded-xl w-fit ms-5 hover:bg-[#10249F] hover:text-white">Let&apos;s begin</button></Link>
            </div>
        </div>
    )
}
